const ebmBands = {
  ...
  front242: {
    ...
    studioAlbums: ['Geography', 'Official Version', 'Front by Front', 'Tyranny >For You<', '06:21:03:11 Up Evil', '05:22:09:12 Off', 'Pulse'],
    importantEPs: ['No Comment', 'Still & Raw'],
    liveAlbums: ['Live Target', 'Live Code', 'Re:Boot Live'],
    bestCompilation: 'Back Catalogue',
    stillActive: true,
  ...
  andOne: {
    ...
    studioAlbums: ['Anguish', 'Flop!', 'Spot', 'I.S.T.', 'Nordhausen', '9.9.99 Uhr', 'Virgin Superstar', 'Aggressor', 'Bodypop', 'Bodypop 1 1/2', 'Tanzomat', 'S.T.O.P.', 'Magnet/Achtung 80/Propeller'],
    importantEPs: ['Sitata Tirulala', 'Frontfeuer', 'Zerstörer'],
    liveAlbums: ['Live'],
    bestCompilation: 'Naghavi\'s Selection 97 - 03',
    stillActive: true,
  ...
  borghesia: {
    ...
    studioAlbums: ['Borghesia', 'Clones', 'Ljubav Je Hladnija Od Smrti', 'No Hope No Fear', 'Escorts and Models', 'Resistance', 'Dreamers in Colour', 'Pro Choice', 'And Man Created God'],
    importantEPs: ['Doublebill (with Click Click)'],
    liveAlbums: ['Better Live Than Dead'],
    bestCompilation: '20th Century - Selected Works',
    stillActive: true,
  ...
  dieKrupps: {
    ...
    studioAlbums: ['Stahlwerksynfonie', 'Volle Kraft Voraus!', 'Entering the Arena', 'I', 'A Tribute to Metallica', 'II - The Final Option', 'Odyssey of the Mind (III)', 'Paradise Now', 'The Machinists of Joy', 'V - Metal Machine Music', 'Stahlwerkrequiem'],
    importantEPs: ['Als Wären Wir Für Immer'],
    liveAlbums: ['Live im Schatten der Ringer'],
    bestCompilation: 'Too Much History (Vol. 1 + 2)',
    stillActive: true,
    countryOfOrigin: 'Germany',
    bestSong: 'Germaniac'
  },
  ...
  hocico: {
    ...
    bestCompilation: 'The Spell of the Spider',
    stillActive: true,
  ...
  agrumh: {
    ...
    bestCompilation: 'We Were à;GRUMH... And You Were Not!',
    stillActive: true,
    countryOfOrigin: 'Belgium',
    bestSong: 'Hammam'
  },
  ...
  covenant: {
    ...
    studioAlbums: ['Dreams of a Cryotank', 'Sequencer', 'Europa', 'United States of Mind', 'Northern Light', 'Skyshaper', 'In Transit', 'Modern Ruin', 'Leaving Babylon', 'The Blinding Dark'],
    importantEPs: ['Theremin EP', 'Euro E.P.'],
    liveAlbums: ['Synergy: Live in Europe'],
  ...
  nitzerEbb: {
    ...
    studioAlbums: ['That Total Age', 'Belief', 'Showtime', 'Ebbhead', 'Big Hit', 'Industrial Complex'],
    importantEPs: ['NE + DK - Join in the Rhythm of Machines'],
    liveAlbums: ['NE + HH: Live at the Markthalle'],
    bestCompilation: 'Body of Work',
    stillActive: true,
  ...
  theKlinik: {
    ...
    studioAlbums: ['Sabotage', 'Plague', 'Face to Face', 'Box', 'Time', 'Contrast', 'Stitch', 'To the Knife', 'Awake', 'Blanket of Fog', 'Sonic Surgery', 'Akhet', 'Dark Surgery', 'Gluttony', 'Greed', 'Eat Your Heart Out', 'Reset'],
    importantEPs: ['Fever', 'Black Leather'],
    liveAlbums: ['Live', 'Live at Wave-Gotik-Treffen 2004'],
    bestCompilation: 'The Klinik 84 91 (Box)',
    stillActive: true,
    countryOfOrigin: 'Belgium',
